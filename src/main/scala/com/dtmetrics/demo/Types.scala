...
final case class Tick(cpu: Double, mem: Double, lat: Double) {
  def toPrometheus: String = {
    ...
    "# HELP cn_app_cpu Application CPU usage percent\n" +
      "# TYPE cn_app_cpu gauge\n" +
      "cn_app_cpu " + cpuStr + "\n" +
      "# HELP cn_app_mem Application memory usage percent\n" +
      "# TYPE cn_app_mem gauge\n" +
      "cn_app_mem " + memStr + "\n" +
      "# HELP cn_app_lat Application latency milliseconds\n" +
      "# TYPE cn_app_lat gauge\n" +
      "cn_app_lat " + latStr + "\n"
  }
}
